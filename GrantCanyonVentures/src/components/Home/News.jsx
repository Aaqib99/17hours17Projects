    ...
    <section className="my-14">
      <Container>
        <div>
          ...
          <div className="grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 items-start gap-8 mt-8">
            {cards.map((card) => (
              <div
                className="h-auto w-[280px] mx-auto px-2 pt-2 pb-4 rounded-md border-2 border-gray-200 relative z-10"
                key={card.id}
              >
