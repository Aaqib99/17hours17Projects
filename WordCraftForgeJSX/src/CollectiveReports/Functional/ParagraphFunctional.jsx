...
const ParagraphFunctional = (reportsData) => {

    // this will always be in portrait mode

    let allSections = [];

    reportsData.map((reportItem)=>{
        // let firstSection = SectionOne(reportItem , "F", true);
        let secondSection = SectionTwo(reportItem, "FP", true);
            ...
            children: [
              ...
              newLine,
                ...
                new Paragraph({
                    ...
                    children: [
                      new TextRun({
                        children: ["Paragraph-Formatted Functional Assessment Report Document:",
                        ],
                        size: 24,
                        bold : true,
                        font: "Calibri",
...
export default ParagraphFunctional