...
const ethnicTable = (results) => {
  console.log("Results in ehtnic table", results)
...
let row1 = new TableRow({
  children: [
    new TableCell({
      ...
      children: [plainText("Criterion: ", true, 18)],
      columnSpan: 2,
    }),
    new TableCell({
      ...
      children: [
        plainText(
          `Combined Student Ethnic Diversity`,
          true,
          18
        ),
      ],
...
let row12 = new TableRow({
  ...
  return new Table({
    ...
    rows: [row1, row2, row3, row4, row5,row6,row7,row8,row9,row10,row12],
  });
};
