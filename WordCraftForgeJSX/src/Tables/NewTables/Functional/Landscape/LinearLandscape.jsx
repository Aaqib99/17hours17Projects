...
import plainText, { centeredText, underlineText } from "../../../../Parts/plainText";
...
export const LinearLandscape = (userData, type) => {
        ...
        rows: [
          new TableRow({
            children: [
              new TableCell({
                ...
                children: [centeredText(`Goal Statement ${index + 1}:`, true, 24)],
                borders,
              }),
              new TableCell({
                width: { size: "75%", type: "PERCENTAGE" },
                children: [
                  underlineText(
          ...
          new TableRow({
            children: [
              new TableCell({
                width: { size: "25%", type: "PERCENTAGE" },
                children: [centeredText(`Direct Evidence ${index + 1}.${outcomeIndex + 1}:`, true, 24)],
                borders,
              }),
              new TableCell({
                width: { size: "75%", type: "PERCENTAGE" },
          ...
          new TableRow({
            children: [
              new TableCell({
                width: { size: "25%", type: "PERCENTAGE" },
                children: [centeredText(`Indirect Evidence ${index + 1}.${outcomeIndex + 1}: `, true, 24)],
                borders,
              }),
              new TableCell({
                width: { size: "75%", type: "PERCENTAGE" },
        ...
        outcome.indirectMeasureThree !== ""
          ...
          new TableRow({
            children: [
              new TableCell({
                width: { size: "25%", type: "PERCENTAGE" },
                children: [centeredText(`Direct Threshold ${index + 1}.${outcomeIndex + 1}:`, true, 24)],
                borders,
              }),
              new TableCell({
                width: { size: "75%", type: "PERCENTAGE" },
          ...
          new TableRow({
            children: [
              new TableCell({
                width: { size: "25%", type: "PERCENTAGE" },
                children: [centeredText(`Indirect Threshold ${index + 1}.${outcomeIndex + 1}: `, true, 24)],
                borders,
              }),
              new TableCell({
                width: { size: "75%", type: "PERCENTAGE" },
          ...
          new TableRow({
            children: [
              new TableCell({
                width: { size: "25%", type: "PERCENTAGE" },
                children: [centeredText(`Implementation Results ${index + 1}.${outcomeIndex + 1}:`, true, 24)],
                borders,
              }),
              new TableCell({
                width: { size: "75%", type: "PERCENTAGE" },
