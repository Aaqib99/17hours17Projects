...
const Docs = () => {
  ...
  const getData = () => {
    onSnapshot(collectionRef, (data) => {
      setDocsData(
        data.docs.map((doc) => {
          console.log("data inside main page",doc.data().title)
              ...
              <Grid item key={index} xs={4}>
                ...
                >
                  <Stack justifyContent={"center"}>
                    ...
                    >
                      <IconButton aria-label="delete" onClick={() => getId(docData.id)}>
                      ...
                      <IconButton aria-label="delete"  onClick={() => deleteItem(docData.id)}>
